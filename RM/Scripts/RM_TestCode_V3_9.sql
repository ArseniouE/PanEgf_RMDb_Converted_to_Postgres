...
with cte as (
       select entityid, cdicode,afm, financialid,statementid, statementyear, statementmonths, commonsharecapital, sharepremium, approveddate, approveid
       from per_ralph --per_ralph 
       --where entityid = '118764' 
), cte2 as (select entityid, cdicode,afm,financialid, statementid, statementyear, statementmonths,commonsharecapital, sharepremium,
                   lag(commonsharecapital,1) over (partition by entityid,cdicode,afm, financialid order by statementyear) prev_commonsharecapital,
			       lag(sharepremium,1) over (partition by entityid, cdicode,afm, financialid order by statementyear) prev_sharepremium, approveddate, approveid
            from cte 
           ) 
select entityid, cdicode,afm, financialid, statementid, statementyear, statementmonths,
...
from cte2
order by entityid, cdicode,afm, financialid, statementyear;
...
with cte as (
       ...
       --where entityid = '118764' 
                   ...
                   lag(commonsharecapital,1) over (partition by entityid,cdicode,afm, financialid order by statementyear) prev_commonsharecapital,
			       lag(sharepremium,1) over (partition by entityid, cdicode,afm, financialid order by statementyear) prev_sharepremium,date_rating,
...
select --distinct on(a.pkid_) 
	   ...
	   --,to_char(per.approveddate,'yyyymmdd') as approveddate 	   
	   ,cast(cast(per.approveddate as timestamptz) as varchar(30)) as approveddate
	   ,'20230929' as reference_date ----------------!! external parameter
	   ,concat_ws('|',per.entityid::text,per.versionid_rating::text) as entityid
	   ,per.entityid entityid2	   
	   --,per.FinancialId::int as FinancialId 
	   ,per.Statementid::int as Statementid
...
--select * from final_table --4.344


--103567	"10"	103567	"2680"	"0"	"1355208.0"
--89671	"10"	89671	"2400"	"0"	"0.0"
--91287	"9"	91287	"1520"	"0"	"62798.0"
--30872	"43"	30872	"2460"	"0"	"18971172.0"
--118468	"10"	118468	"1650"	"0"	"0.0"

---select * from final_table where entityid like '%31970%' --4.344 rows new/ --4.380 old

--select * from (
--select fnc_year, cdi,afm,csh,ebitda,eqty,gdwill,nt_incm,sales_revenue,netfixedassets,inventory,nettradereceivables,totalassets,commonsharecapital,tradepayable,
--       totalbankingdebt,shorttermbankingdebt,longtermbankingdebt,totalliabilities,grossprofit,ebit,profitbeforetax,workingcapital,flowsoperationalactivity,
--       flowsinvestmentactivity,flowsfinancingactivity,--chgcommonsharecapital_chgsharepremium,
--	   balancedividendspayable,grossprofitmargin,netprofitmargin,
--       ebitdamargin,totalbankingdebttoebitda,netbankingdebttoebitda,totalliabilitiestototalequity,returnonassets,returnonequity,interestcoverage,
--       currentratio,quickratio,fnc_year,creditcommitteedate,publish_date,approveddate,reference_date--,entityid::text
--	   from final_table2
--except
--select fnc_year, cdi,afm,csh,ebitda,eqty,gdwill,nt_incm,sales_revenue,netfixedassets,inventory,nettradereceivables,totalassets,commonsharecapital,tradepayable,
--       totalbankingdebt,shorttermbankingdebt,longtermbankingdebt,totalliabilities,grossprofit,ebit,profitbeforetax,workingcapital,flowsoperationalactivity,
...
--       currentratio,quickratio,fnc_year,creditcommitteedate,publish_date,approveddate,reference_date--,entityid::text
--	   from olapts.rmtest 
--) x where cdi in ('1387209','454793','1247484','6184904','419841','15568822','15696516','5865829','12996915','0002211514','6739187','1512078'
--					   ,'6077953','733255','1548686','4595638','2456140','2006674','4361677','730003')
--					   --------------tocheck
--					 -- '1622088','12486348','4203477','410783','876119','0004476254','502525','741484',
--					 --  '743037','124203','12782071','1051616','6847000','7171052','193','389175',
--					 -- '18755750','4248711','0007086901','017900678','571607','12750144','18060531'
--					 --  ,'2486718','2901380','1765821','6564069','18020375','4918749','2100827' --'5469869','5469541' abrs
--					  )
--
...
--	   balancedividendspayable,grossprofitmargin,netprofitmargin,
--       ebitdamargin,totalbankingdebttoebitda,netbankingdebttoebitda,totalliabilitiestototalequity,returnonassets,returnonequity,interestcoverage,
--       currentratio,quickratio,creditcommitteedate,publish_date,approveddate,reference_date--,entityid::text
--	   from final_table2
--union all
--	select fnc_year, cdi,afm,csh,ebitda,eqty,gdwill,nt_incm,sales_revenue,netfixedassets,inventory,nettradereceivables,totalassets,commonsharecapital,tradepayable,
--       totalbankingdebt,shorttermbankingdebt,longtermbankingdebt,totalliabilities,grossprofit,ebit,profitbeforetax,workingcapital,flowsoperationalactivity,
...
--       currentratio,quickratio,creditcommitteedate,publish_date,approveddate,reference_date--,entityid::text
--	   from olapts.rmtest 
--) x where cdi = '461868' and fnc_year = '2018'
--					   
--
---
select fnc_year, cdi,afm,csh::text,ebitda::text,eqty::text,gdwill::text,nt_incm::text,sales_revenue::text,netfixedassets::text,inventory::text,
       nettradereceivables::text,totalassets::text,commonsharecapital::text,tradepayable::text,
       totalbankingdebt::text,shorttermbankingdebt::text,longtermbankingdebt::text,totalliabilities::text,grossprofit::text,ebit::text,
	   profitbeforetax::text,workingcapital::text,flowsoperationalactivity::text,
       flowsinvestmentactivity::text,flowsfinancingactivity::text,--chgcommonsharecapital_chgsharepremium,
	   balancedividendspayable::text,grossprofitmargin::text,netprofitmargin::text,
       ebitdamargin::text,totalbankingdebttoebitda::text,netbankingdebttoebitda::text,totalliabilitiestototalequity::text,
	   returnonassets::text,returnonequity::text,interestcoverage::text,
       currentratio::text,quickratio::text,fnc_year::text
	   from final_table where cdi like '%461868%' and fnc_year = '2022'
union all	   
select fnc_year, cdi,afm,csh::text,ebitda::text,eqty::text,gdwill::text,nt_incm::text,sales_revenue::text,netfixedassets::text,inventory::text,
       nettradereceivables::text,totalassets::text,commonsharecapital::text,tradepayable::text,
       totalbankingdebt::text,shorttermbankingdebt::text,longtermbankingdebt::text,totalliabilities::text,grossprofit::text,ebit::text,
	   ...
	   returnonassets::text,returnonequity::text,interestcoverage::text,
       currentratio::text,quickratio::text,fnc_year::text
	from olapts.rm_test_dmpk where cdi like '%461868%' and fnc_year = '2022' 

----------------------UAT----------------------------------

---------------------------balancedividedpayable---------------------------
...
select * from olapts.facthiststmtbalancelatest
where financialid ='34504' and accountid in ('5950','5960') and statementid ='11'
...
and per.ApprovedDate is not null  
and per.flag = 'Legacy'	
and a.statementyear = '2022' and per.cdicode = '2490763' --and per.entityid ='34504' 		
and sharecapital_premium.flag <> 'exclude_from_rating'
order by a.pkid_, a.sourcepopulateddate_ desc,per.ApprovedDate desc
)x 
	)y where rn=1
...
select * from olapts.facthiststmtbalancelatest
where financialid ='92392' and accountid in ('5950','5960') and statementid ='17'
