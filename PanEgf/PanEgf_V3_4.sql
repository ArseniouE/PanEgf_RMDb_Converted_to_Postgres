...
)x where cdi not in ('417143','1247484','15607558','15615434','18228188','20148605')

select *
from (
select 'new' as flag, * from final_test1 --where cdi = '20148605'
union all
select 'old' as flag,* from final_test --where cdi = '20148605'
)x where cdi not in ('417143','1247484','15607558','15615434','18228188','20148605')
order by cdi, afm

select * from olapts.panegftest where cdi in ('4836644','12403191','15617860')
4836644   ----na to doume   --einai ok aforoun idio entityid se diaforetiko cdi 
12403191  ---na to doume  --einai ok aforoun idio entityid se diaforetiko cdi
15617860  ---na to doume  --einai ok aforoun idio entityid se diaforetiko cdi

--kovontai sthn gefura?
--"cdi"	"afm"
--"0"	"997802345"
--"443444"	"96000486"
--"124203"	"998477382"
